...
function App() {
  ...
  const [favAirline, setFavAirline] = useState("");

  const validate = {
    name: (name) => validateName("Tu Nombre", name),
    email: validateEmail,
                    ...
                    <div className="hidden md:block">
                      <div className="ml-10 flex items-baseline space-x-4">
                        <ul className="list-none overflow-hidden">
                          {airlines.map((airline, itemIdx) =>
                            itemIdx === 0 ? (
                              <Fragment key={airline.id}>
                                <li
                                  href="#"
                                  className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium float-left cursor-pointer"
                                  onClick={() => setFavAirline(airline.name)}
                                >
                                  {airline.name}
                                </li>
                              </Fragment>
